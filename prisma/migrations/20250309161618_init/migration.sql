...
CREATE TABLE `Trigger` (
    `id` VARCHAR(191) NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    `type` ENUM('CONTACT_FGRM') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `subAccountId` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Subscription` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `plan` ENUM('price_10MhuI10l5Bk5htqogRXZ2e', 'price_10MhtIcId5Bk5htaxCVf5mj') NULL,
...
CREATE TABLE `Permissions` (
    ...
    `userId` VARCHAR(191) NOT NULL,
    `subAccountId` VARCHAR(191) NOT NULL,
    `accessLevel` ENUM('NONE', 'READ', 'WRITE', 'ADMIN') NOT NULL DEFAULT 'READ',
    `canManageFunnels` BOOLEAN NOT NULL DEFAULT false,
    ...
    `canManageStripe` BOOLEAN NOT NULL DEFAULT false,
    `canViewMetrics` BOOLEAN NOT NULL DEFAULT false,
    `canManageSettings` BOOLEAN NOT NULL DEFAULT false,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `Permissions_userId_idx`(`userId`),
